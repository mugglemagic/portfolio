...
const __vite_glob_0_1 = /* @__PURE__ */ Object.freeze(/* @__PURE__ */ Object.defineProperty({
  __proto__: null,
  default: FR_0001_the_multizone_gambit_md,
  metadata: metadata$7
}, Symbol.toStringTag, { value: "Module" }));
const metadata$6 = {
  "ref": "FR-0002",
...
<span class="token punctuation">)</span><span class="token punctuation">;</span></code>`)}</pre> <p><strong>Layer 2: The Visual Track</strong></p> <p>Inside the invisible touch target sits the visual switch - the track that changes colour when toggled. This can be any size the design requires: 20 pixels for a compact switch, 24 for default, 28 for large. The visual size is independent of the touch target size.</p> <pre class="language-typescript">${html(`<code class="language-typescript"><span class="token keyword">const</span> switchTrackVariants <span class="token operator">=</span> <span class="token function">cva</span><span class="token punctuation">(</span>
  ...
  <span class="token punctuation">&#123;</span>
    ...
    <span class="token punctuation">&#125;</span><span class="token punctuation">,</span>
  <span class="token punctuation">&#125;</span>
<span class="token punctuation">)</span><span class="token punctuation">;</span></code>`)}</pre> <p><strong>Layer 3: The Sliding Thumb</strong></p> <p>The innermost layer is the circular thumb that slides to indicate state. Pure visual feedback, no interaction handling.</p> <pre class="language-typescript">${html(`<code class="language-typescript"><span class="token keyword">const</span> switchThumbVariants <span class="token operator">=</span> <span class="token function">cva</span><span class="token punctuation">(</span>
  ...
  <span class="token punctuation">&#123;</span>
    ...
    <span class="token punctuation">&#125;</span><span class="token punctuation">,</span>
  <span class="token punctuation">&#125;</span>
<span class="token punctuation">)</span><span class="token punctuation">;</span></code>`)}</pre> <p>The assembled component nests these layers:</p> <pre class="language-tsx">${html(`<code class="language-tsx"><span class="token tag"><span class="token tag"><span class="token punctuation">&lt;</span><span class="token class-name">Switch</span></span> <span class="token attr-name">className</span><span class="token script language-javascript"><span class="token script-punctuation punctuation">=</span><span class="token punctuation">&#123;</span><span class="token function">switchOuterVariants</span><span class="token punctuation">(</span><span class="token punctuation">)</span><span class="token punctuation">&#125;</span></span><span class="token punctuation">></span></span><span class="token plain-text">
...
const __vite_glob_0_7 = /* @__PURE__ */ Object.freeze(/* @__PURE__ */ Object.defineProperty({
  __proto__: null,
  default: FR_0022_one_doc_site_to_rule_them_all_md,
  metadata: metadata$1
}, Symbol.toStringTag, { value: "Module" }));
const metadata = {
  "ref": "WP-001",
...
2024 saw a significant spike (56.8 errors) before improving in 2025 (51.0).</code>`)}</pre> <h3>WCAG Failure Rates</h3> <table><thead><tr><th>Year</th><th>Failure Rate</th><th>Change</th><th>Errors/Page</th></tr></thead><tbody><tr><td>2019</td><td>97.8%</td><td>Baseline</td><td>59.6</td></tr><tr><td>2020</td><td>98.1%</td><td>+0.3%</td><td>60.9</td></tr><tr><td>2021</td><td>97.4%</td><td>-0.7%</td><td>51.4</td></tr><tr><td>2022</td><td>96.8%</td><td>-0.6%</td><td>50.8</td></tr><tr><td>2023</td><td>96.3%</td><td>-0.5%</td><td>50.0</td></tr><tr><td>2024</td><td>95.9%</td><td>-0.4%</td><td>56.8</td></tr><tr><td>2025</td><td>94.8%</td><td>-1.1%</td><td>51.0</td></tr></tbody></table> <p><strong>In seven years, the failure rate dropped by only 3 percentage points.</strong> At this rate, achieving broad web accessibility would take decades.</p> <h3>Page Complexity Growth</h3> <p>While error rates slowly declined, page complexity exploded:</p> <pre class="language-undefined">${html(`<code class="language-undefined">Home Page Elements (Average)
━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━
...
━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━
These 6 categories account for 96.4% of ALL detected errors</code>`)}</pre> <p><strong>Addressing just these six issues would transform web accessibility.</strong> Yet year after year, they persist.</p> <h2>The Framework Factor</h2> <p>Modern JavaScript frameworks correlate with increased accessibility errors:</p> <pre class="language-undefined">${html(`<code class="language-undefined">Average Errors by Framework (2025)
━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━
...
Result: Looks like 32px. Touches like 44px. Everyone wins.</code>`)}</pre> <hr/> <h1>Part VI: Implementation Guide: Building a Button Component</h1> <p>Let’s build a production-ready Button component using the Three-Layer Architecture. This implementation uses React, TypeScript, React Aria, and Class Variance Authority (CVA).</p> <h2>Technology Stack</h2> <table><thead><tr><th>Technology</th><th>Purpose</th></tr></thead><tbody><tr><td>React</td><td>Component framework</td></tr><tr><td>TypeScript</td><td>Type safety</td></tr><tr><td>React Aria</td><td>Accessible primitives</td></tr><tr><td>CVA (Class Variance Authority)</td><td>Variant-based styling</td></tr><tr><td>Tailwind CSS</td><td>Utility classes</td></tr></tbody></table> <h2>Step 1: Define Layer 1 (Touch Target)</h2> <p>Layer 1 is the outermost element—the actual interactive button. It handles:</p> <ul><li>Minimum touch target size (44×44px)</li> <li>Focus ring for keyboard navigation</li> <li>Disabled state styling</li> <li>Pointer event handling</li></ul> <pre class="language-typescript">${html(`<code class="language-typescript"><span class="token comment">/**
...
<span class="token punctuation">]</span><span class="token punctuation">.</span><span class="token function">join</span><span class="token punctuation">(</span><span class="token string">" "</span><span class="token punctuation">)</span><span class="token punctuation">;</span></code>`)}</pre> <h2>Step 4: Compose the Component</h2> <pre class="language-typescript">${html(`<code class="language-typescript"><span class="token string">"use client"</span><span class="token punctuation">;</span>
...
<span class="token tag"><span class="token tag"><span class="token punctuation">&lt;</span><span class="token class-name">Button</span></span> <span class="token attr-name">visualSize</span><span class="token attr-value"><span class="token punctuation attr-equals">=</span><span class="token punctuation">"</span>lg<span class="token punctuation">"</span></span><span class="token punctuation">></span></span><span class="token plain-text">Submit Application</span><span class="token tag"><span class="token tag"><span class="token punctuation">&lt;/</span><span class="token class-name">Button</span></span><span class="token punctuation">></span></span></code>`)}</pre> <h3>Icon Buttons</h3> <pre class="language-tsx">${html(`<code class="language-tsx"><span class="token comment">// Icon button - 40px visual, 44px touch</span>
...
</span><span class="token tag"><span class="token tag"><span class="token punctuation">&lt;/</span><span class="token class-name">Button</span></span><span class="token punctuation">></span></span></code>`)}</pre> <h3>Carousel Dots</h3> <pre class="language-tsx">${html(`<code class="language-tsx"><span class="token comment">// Carousel pagination - 20px visual, 44px touch</span>
...
</span><span class="token tag"><span class="token tag"><span class="token punctuation">&lt;/</span>div</span><span class="token punctuation">></span></span></code>`)}</pre> <h3>Loading States</h3> <pre class="language-tsx">${html(`<code class="language-tsx"><span class="token comment">// Loading with screen reader announcement</span>
<span class="token tag"><span class="token tag"><span class="token punctuation">&lt;</span><span class="token class-name">Button</span></span> <span class="token attr-name">loading</span> <span class="token attr-name">loadingText</span><span class="token attr-value"><span class="token punctuation attr-equals">=</span><span class="token punctuation">"</span>Saving your changes...<span class="token punctuation">"</span></span><span class="token punctuation">></span></span><span class="token plain-text">
  ...
  <span class="token function">describe</span><span class="token punctuation">(</span><span class="token string">'Focus Ring Location'</span><span class="token punctuation">,</span> <span class="token punctuation">(</span><span class="token punctuation">)</span> <span class="token operator">=></span> <span class="token punctuation">&#123;</span>
    ...
    <span class="token punctuation">&#125;</span><span class="token punctuation">)</span><span class="token punctuation">;</span>
  <span class="token punctuation">&#125;</span><span class="token punctuation">)</span><span class="token punctuation">;</span>
<span class="token punctuation">&#125;</span><span class="token punctuation">)</span><span class="token punctuation">;</span></code>`)}</pre> <h3>Visual Regression Tests</h3> <pre class="language-typescript">${html(`<code class="language-typescript"><span class="token comment">// Verify visual appearance at different sizes</span>
...
</span><span class="token tag"><span class="token tag"><span class="token punctuation">&lt;/</span>div</span><span class="token punctuation">></span></span></code>`)}</pre> <pre class="language-undefined">${html(`<code class="language-undefined">Why Overlapping Touch Targets FAIL Users
━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━
...
Higher z-index elements STEAL touches intended for adjacent elements.</code>`)}</pre> <h2>Anti-Pattern: Negative Margins</h2> <p>⚠️ <strong>DO NOT USE THIS APPROACH</strong></p> <p>Using negative margins to pull touch targets closer creates the same problem as overlapping with z-index:</p> <pre class="language-css">${html(`<code class="language-css"><span class="token comment">/* ❌ BAD - DO NOT DO THIS */</span>
...
<span class="token punctuation">&#125;</span></code>`)}</pre> <pre class="language-undefined">${html(`<code class="language-undefined">Grid-Aware Layout
━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━
...
async function getPosts() {
  const modules = /* @__PURE__ */ Object.assign({
    "/src/content/blog/FR-0000-why-we-are-writing-this.md": __vite_glob_0_0,
    "/src/content/blog/FR-0001-the-multizone-gambit.md": __vite_glob_0_1,
    "/src/content/blog/FR-0002-why-react-aria-won.md": __vite_glob_0_2,
    "/src/content/blog/FR-0003-the-44px-illusion.md": __vite_glob_0_3,
    "/src/content/blog/FR-0004-the-compliance-trap.md": __vite_glob_0_4,
    "/src/content/blog/FR-0005-the-server-side-shield.md": __vite_glob_0_5,
    "/src/content/blog/FR-0006-the-observability-iceberg.md": __vite_glob_0_6,
    "/src/content/blog/FR-0022-one-doc-site-to-rule-them-all.md": __vite_glob_0_7,
    "/src/content/blog/WP-001-three-layer-component-architecture.md": __vite_glob_0_8
  });
  const posts = [];
...
async function getPost(slug) {
  try {
    const post = await __variableDynamicImportRuntimeHelper(/* @__PURE__ */ Object.assign({ "../../content/blog/FR-0000-why-we-are-writing-this.md": () => Promise.resolve().then(() => __vite_glob_0_0), "../../content/blog/FR-0001-the-multizone-gambit.md": () => Promise.resolve().then(() => __vite_glob_0_1), "../../content/blog/FR-0002-why-react-aria-won.md": () => Promise.resolve().then(() => __vite_glob_0_2), "../../content/blog/FR-0003-the-44px-illusion.md": () => Promise.resolve().then(() => __vite_glob_0_3), "../../content/blog/FR-0004-the-compliance-trap.md": () => Promise.resolve().then(() => __vite_glob_0_4), "../../content/blog/FR-0005-the-server-side-shield.md": () => Promise.resolve().then(() => __vite_glob_0_5), "../../content/blog/FR-0006-the-observability-iceberg.md": () => Promise.resolve().then(() => __vite_glob_0_6), "../../content/blog/FR-0022-one-doc-site-to-rule-them-all.md": () => Promise.resolve().then(() => __vite_glob_0_7), "../../content/blog/WP-001-three-layer-component-architecture.md": () => Promise.resolve().then(() => __vite_glob_0_8) }), `../../content/blog/${slug}.md`, 5);
    return {
